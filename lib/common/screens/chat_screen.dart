      ...
      child: Scaffold(
          ...
          chatController.requestStatus.value == 0
            ...
            children: [
              Expanded(
                ...
                child: StreamBuilder(
                    stream: FirebaseFirestore.instance.collection("Chats")
                        ...
                        .limit(chatController.perPage.value).snapshots(),
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              if (index == snapshot.data!.docs.length) {
                                  ...
                                  Timer(const Duration(seconds: 3), () {
                                    setState(() {
                                      chatController.isLoading.value =
                                          chatController.showLoadingIndicator
                                              .value = false;
                                    });
                                  });
                                ...
                                String text = daysDifferenceForTitle == 0
                                    ? "chat_title_today".tr
                                ...
                                "${DateTime
                                    .now()
                                    .add(
                                    Duration(days: -daysDifferenceForTitle))
                                    .day - 1}  ${chatController
                                    .monthsList[DateTime
                                    .now()
                                    .add(
                                    Duration(days: -daysDifferenceForTitle))
                                ...
                                return Padding(
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      Visibility(
                                        visible: chatController.showDate.value,
                                        child:
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            Visibility(
                                              visible: chatController.showDate
                                                  .value,
              ...
              chatController.isSeenStatusExist.value ? Padding(
                padding: const EdgeInsets.fromLTRB(10, 5, 15, 0),
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.end,
                  children: [
                    AppTextWidgets.blackText(
                      text: "seen_str".tr, color: AppColors.GREY, size: 10,),
                  ],
                ),
              ) : Container(),

              chatController.isFileUploading.value ? Container(
                color: AppColors.greyShade1,
                child: Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Row(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            LinearProgressIndicator(
                              minHeight: 2,
                              value: chatController.uploadingProgress.value,
                            ),
                          ],
                        ),
                      ),
                      const SizedBox(width: 10,),
                      Icon(Icons.cancel, color: AppColors.themeColor3,),
                    ],
                  ),
                ),
              ) : Container(),

              chatController.statusToWidget(chatController.requestStatus.value),
