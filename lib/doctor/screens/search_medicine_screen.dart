                            ...
                            suffixIcon: GestureDetector(
                              onTap: () {
                                ...
                                if (medicineController
                                  ...
                                  medicineController
                                      .isSearchMedicineEmpty.value = true;
                                  Fluttertoast.showToast(
                                      msg: 'search_medicine_error'.tr,
                                      toastLength: Toast.LENGTH_SHORT,
                                      gravity: ToastGravity.BOTTOM,
                                                  ...
                                                  children: [
                                                    Expanded(
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          Text(
                                                            medicineController.ll[index].name ?? "",
                                                            maxLines: 1,
                                                            style: TextStyle(
                                                              fontSize: 16,
                                                              fontFamily:
                                                          ...
                                                          Text(
                                                            medicineController.ll[index].description ?? "",
                                                            maxLines: 2,
                                                            style: TextStyle(
                                                              fontFamily:
                                                                  AppFontStyleTextStrings
                                              ...
                                              children: [
                                                Expanded(
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      Text(
                                                        medicineController.mostUsedMedicineList[index].name ?? "",
                                                        maxLines: 1,
                                                        style: TextStyle(
                                                          fontSize: 16,
                                                          fontFamily:
                                                      ...
                                                      const SizedBox(height: 4),
                                                      Text(
                                                        medicineController.mostUsedMedicineList[index].description ?? "",
                                                        maxLines: 2,
                                                        style: TextStyle(
                                                          fontFamily:
                                                              AppFontStyleTextStrings
                                    ...
                                    if (ll1.isEmpty) {
                                      ...
                                      Get.to(
                                        MedicinseScreen(
                                          ll: ll1,
                                          oldData:
                                              medicineController.medicineMap,
